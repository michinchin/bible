String languageNameFromCode(String code) => _isoLangs[code]?.first ?? 'Unknown';
String nativeNameFromCode(String code) => _isoLangs[code]?.last ?? 'Unknown';

// cspell: disable

// From: https://stackoverflow.com/a/54000593
const _isoLangs = {
  'ab': ['Abkhaz', 'аҧсуа'],
  'aa': ['Afar', 'Afaraf'],
  ...
  'cu': ['Old Slavonic', 'ѩзыкъ словѣньскъ'],
