...
///    by [TecPageRoute.buildTransitions].
///
class TecPageRoute<T> extends PageRoute<T> {
  /// Construct a TecPageRoute whose contents are defined by [builder].
  ///
  ...
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) {
    ...
    return _isFullscreenDialogRoute(nextRoute);
  }
...
///
/// Returns a [PageTransitionsTheme] that uses a TecCupertinoPageRoute for iOS and macOS.
///
PageTransitionsTheme tecPageTransitionsTheme(BuildContext context) {
  final builders = Map<TargetPlatform, PageTransitionsBuilder>.of(
      Theme.of(context).pageTransitionsTheme.builders);
  const builder = TecCupertinoPageTransitionsBuilder();
  builders[TargetPlatform.iOS] = builder;
  builders[TargetPlatform.macOS] = builder;
...
class TecCupertinoPageTransitionsBuilder extends PageTransitionsBuilder {
  ...
  Widget buildTransitions<T>(PageRoute<T> route, BuildContext context, Animation<double> animation,
      Animation<double> secondaryAnimation, Widget child) {
    return TecCupertinoPageRoute.buildPageTransitions<T>(
...
bool _isFullscreenDialogRoute(TransitionRoute route) {
  return (route is TecPageRoute && !route.fullscreenDialog) ||
      (route is TecCupertinoPageRoute && !route.fullscreenDialog) ||
      (route is MaterialPageRoute && !route.fullscreenDialog) ||
...
class TecCupertinoPageRoute<T> extends PageRoute<T> {
  ...
  /// The title string of the previous [TecCupertinoPageRoute].
  ///
  ...
  /// is not a [TecCupertinoPageRoute].
  ///
  /// See also:
  ///
  ...
  void didChangePrevious(Route<dynamic> previousRoute) {
    final previousTitleString = previousRoute is TecCupertinoPageRoute ? previousRoute.title : null;
  ...
  /// Returns a [TecCupertinoFullscreenDialogTransition] if [route] is a full
  /// screen dialog, otherwise a [TecCupertinoPageTransition] is returned.
  ///
  /// Used by [TecCupertinoPageRoute.buildTransitions].
  ///
  /// This method can be applied to any [PageRoute], not just
  /// [TecCupertinoPageRoute]. It's typically used to provide a Cupertino style
  ...
  static Widget buildPageTransitions<T>(
    ...
    if (route.fullscreenDialog) {
      return TecCupertinoFullscreenDialogTransition(
...
///
class TecCupertinoFullscreenDialogTransition extends StatelessWidget {
  ...
  ///    Used to precisely track back gesture drags.
  ///
  TecCupertinoFullscreenDialogTransition({
    Key key,
    @required Animation<double> primaryRouteAnimation,
...
///
/// This is created by a [TecCupertinoPageRoute] in response from a gesture caught
...
class _CupertinoBackGestureController<T> {
  ...
  void dragEnd(double velocity) {
    ...
    if (controller.isAnimating) {
      ...
      // curve of the page transition mid-flight since TecCupertinoPageTransition
